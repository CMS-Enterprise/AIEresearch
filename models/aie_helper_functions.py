...
def load_mistral7b_model(quantization=True,
                         save_dir='~/aie_demo_playground/saved_models'): #Ensure this is the right path in your env!
    '''
    Loads Mistral-7B-Instruct-v0.2 model saved in ~/aie_demo_playground/saved_models.
